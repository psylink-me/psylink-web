...
[I drove F-Zero with Prototype #2 before](/devlog/fzero), but back then I
...
- Removed unnecessary [vias](https://en.wikipedia.org/wiki/Via_(electronics)).
  ...
  measure.)
- The label now shows the new name ["psylink" instead of "myocular"](/devlog/new-name)
